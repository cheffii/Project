...
public class Coordinate implements Comparable<Coordinate> {
    ...
    public static Coordinate add1(Coordinate a,Coordinate b) {
        return new Coordinate(a.x - b.x, a.y + b.y);
    }
    public static Coordinate add2(Coordinate a,Coordinate b) {
        return new Coordinate(a.x + b.x, a.y - b.y); 
    }
    public static Coordinate add3(Coordinate a,Coordinate b) {
        return new Coordinate(a.x - b.x, a.y - b.y);
    }
    ...
    public Coordinate moveTo1(Direction d) {
        return add1(this,d.v); 
    }
    public Coordinate moveTo2(Direction d) {
        return add2(this,d.v);
    }
    public Coordinate moveTo3(Direction d) {
        return add3(this,d.v);
    }
  ...
  //-----------------------------------------------------------------------------------------------------
    ...
    // Apfel is Rechts 
    public boolean getapple(Coordinate apple) {
    	return x >= 0 && y >= 0 && x <= apple.x  ;
    }
    // Apfels ist unten
    public boolean getapple1(Coordinate apple) {   	
    	return x >= 0 && y <= 0 && y <= apple.y ;
    }
    //Apfel ist Links 
    public boolean getapple2(Coordinate apple) {
        return x >= 0 && y >= 0  && x >= apple.x;
    }
    // Apfels ist Oben
    public boolean getapple3(Coordinate apple) {
        return x >= 0 && y >= 0 && y >= apple.y ;
    }

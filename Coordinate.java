...
public class Coordinate implements Comparable<Coordinate> {
    ...
    public static Coordinate findx(Coordinate a,Coordinate b) {
        return new Coordinate(a.x, b.x);
    }
    public static Coordinate findy(Coordinate a,Coordinate b) {
        return new Coordinate(a.y, b.y);
    }
     ...
     */
    public Coordinate moveTob(Direction d) {
        return findx(this,this);
    }
    public Coordinate moveToa(Direction d) {
        return findy(this,this);
    }
    ...
    public boolean appleLoc(Coordinate apple) {
